...
A = plot(curv,dfE,'r+',curv2,dfE2,'k+',curvfit1,fit,'r',curvfit2,fit2,'k',...
    curvf4,dfEf4,'rs',curv2f4,dfE2f4,'ks',curvfit1f4,fitf4,'r',curvfit2f4,fit2f4,'k',...
    curvf3,dfEf3,'r^',curv2f3,dfE2f3,'k^',curvfit1f3,fitf3,'r',curvfit2f3,fit2f3,'k',...
    curvf7,dfEf7,'rd',curv2f7,dfE2f7,'kd',curvfit1f7,fitf7,'r',curvfit2f7,fit2f7,'k',...
    curvf6,dfEf6,'ro',curv2f6,dfE2f6,'ko',curvfit1f6,fitf6,'r',curvfit2f6,fit2f6,'k');
%plot(curv,dfE,'r+',curv2,dfE2,'k+');

set(A(1),'markersize',9);
set(A(2),'markersize',9);
set(A(3),'linewidth',1.2);
set(A(4),'linewidth',1.2);
set(A(5),'markersize',9);
set(A(6),'markersize',9);
set(A(7),'linewidth',1.2);
set(A(8),'linewidth',1.2);
set(A(9),'markersize',9);
set(A(10),'markersize',9);
set(A(11),'linewidth',1.2);
set(A(12),'linewidth',1.2);
set(A(13),'markersize',9);
set(A(14),'markersize',9);
set(A(15),'linewidth',1.2);
set(A(16),'linewidth',1.2);
set(A(17),'markersize',9);
set(A(18),'markersize',9);
set(A(19),'linewidth',1.2);
set(A(20),'linewidth',1.2);
