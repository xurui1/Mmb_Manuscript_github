double Conc(double **phi,double **w,int *Ns,double ds,double dr, double *mu,double volume, double *loop, int out_loop, int iter,int pin_location){
    ...
    if (out_loop==1 && iter%100==0 ){
        ...
        calcloop(qA2,qB2LL,qB2LR,qA3,Ns,w,mu,imax,loop,dr,ds);
    }
