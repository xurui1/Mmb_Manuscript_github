...
path= "/Users/ashkandehghan/Desktop/SCFT_CODES/ADI_Bilayer/DATA/Test_Fig3_Review_Paper/" #Mac
...
plot f1(x) lc -1 lt 1 lw 3,\
 path."Mod1_Results.dat" using 1:(2*(($2-$3)/$4)*$5/$1) w lp lc -1 pt 6 lw 3
...
plot f1(x) lc -1 lt 1 lw 3,\
 path."Mod1_Results.dat" using 1:(2*(($2-$3)/$4)*$5) w lp lc -1 pt 6 lw 3
